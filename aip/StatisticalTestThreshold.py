...
class StatisticalTestThreshold(BaseEstimator, SelectorMixin):
    ...
    '''
    def __init__(self, metric='MannWhitneyU', threshold=0.05,
                 bonferonni=True):
        '''
        Parameters
        ----------
    ...
    def fit(self, X_train, Y_train):
        ...
        for n_feat in range(0, X_train.shape[1]):
            ...
            try:
                ...
                print("[Warning] " + str(e) + '. Replacing metric value by 1.')
                metric_value = 1

            if self.bonferonni:
                # Apply bonferonni correction on the p-value by altering threshold
